...
pub fn ned_to_ecef(ned: &na::Vector3<f32>, ref_lat: f32, ref_lon: f32, ref_alt: f32) -> na::Vector3<f32> {
...
pub fn ecef_to_ned(ecef: &na::Vector3<f32>, ref_lat: f32, ref_lon: f32, ref_alt: f32) -> na::Vector3<f32> {
    let ref_ecef = lla_to_ecef(ref_lat, ref_lon, ref_alt);
